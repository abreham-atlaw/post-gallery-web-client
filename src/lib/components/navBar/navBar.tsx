  ...
  return (
      <div className="relative">
        ...
        <div className='lg:hidden pt-10 px-3 flex flex-row items-center justify-between'>
          ...
          <img  className='h-8 lg:hidden' onClick={() => setOpen(!open)} src={open ? Menu : Close} />
        </div>
        <div className={` ${open ? 'hidden' : 'absolute'} flex flex-col p-6 bg-white mt-4 mx-10 w-min right-0 rounded-[12px] shadow-[0px_0px_50px_rgba(0,0,0,0.3)] lg:hidden`}>
