    ...
    return (
        <div >
          ...
          <div className='flex flex-row flex-wrap'>
			{
				blogs.map(
					(blog: Publishment) => <Link to={`/admin/blog-press/edit/${blog.getPK()}`} className='font-Lato w-full lg:w-2/5 flex flex-row justify-start items-center h-32 pr-3 mr-5 mb-6 font-medium border-[3px] rounded-md border-[#D6D6D6]'>
			...
			{
				presses.map(
					(press: Press) => <Link to={`/admin/blog-press/edit/${press.getPK()}`} className='font-Lato w-full lg:w-2/5 flex flex-row justify-start items-center h-32 pr-3 mr-5 mb-6 font-medium border-[3px] rounded-md border-[#D6D6D6]'>
